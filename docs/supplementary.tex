...
The good f1-score of 0.90 shows that the following situations are indeed exceptions.
...
Further information on the manual evaluation is made available under \texttt{docs/} in the accompanying Github repository.
